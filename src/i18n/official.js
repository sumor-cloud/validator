export default {
  ...
  zh: {
    SUMOR_REQUIRED: '必填项',
    SUMOR_STRING_LENGTH: '长度必须小于等于 {length} 个字符',
    SUMOR_INVALID_NUMBER: '无效数字 {value}',
    SUMOR_NUMBER_LENGTH: '长度必须小于等于 {length} 位数'
  },
  es: {
    SUMOR_REQUIRED: 'Campo obligatorio',
    SUMOR_STRING_LENGTH: 'La longitud debe ser menor o igual a {length} caracteres',
    SUMOR_INVALID_NUMBER: 'Número inválido {value}',
    SUMOR_NUMBER_LENGTH: 'La longitud debe ser menor o igual a {length} dígitos'
  },
  fr: {
    SUMOR_REQUIRED: 'Champ obligatoire',
    SUMOR_STRING_LENGTH: 'La longueur doit être inférieure ou égale à {length} caractères',
  ...
  de: {
    SUMOR_REQUIRED: 'Pflichtfeld',
    SUMOR_STRING_LENGTH: 'Länge muss kleiner oder gleich {length} Zeichen sein',
    SUMOR_INVALID_NUMBER: 'Ungültige Nummer {value}',
    SUMOR_NUMBER_LENGTH: 'Länge muss kleiner oder gleich {length} Ziffern sein'
  },
  ja: {
    SUMOR_REQUIRED: '必須項目',
    SUMOR_STRING_LENGTH: '長さは {length} 文字以下である必要があります',
    SUMOR_INVALID_NUMBER: '無効な番号 {value}',
    SUMOR_NUMBER_LENGTH: '長さは {length} 桁以下である必要があります'
  },
  ko: {
    SUMOR_REQUIRED: '필수 항목',
    SUMOR_STRING_LENGTH: '길이는 {length} 자 이하여야 합니다',
    SUMOR_INVALID_NUMBER: '잘못된 번호 {value}',
    SUMOR_NUMBER_LENGTH: '길이는 {length} 자 이하여야 합니다'
  },
  ru: {
    SUMOR_REQUIRED: 'Обязательное поле',
    SUMOR_STRING_LENGTH: 'Длина должна быть не более {length} символов',
    SUMOR_INVALID_NUMBER: 'Неверное число {value}',
    SUMOR_NUMBER_LENGTH: 'Длина должна быть не более {length} цифр'
  },
  pt: {
    SUMOR_REQUIRED: 'Campo obrigatório',
    SUMOR_STRING_LENGTH: 'O comprimento deve ser menor ou igual a {length} caracteres',
    SUMOR_INVALID_NUMBER: 'Número inválido {value}',
    SUMOR_NUMBER_LENGTH: 'O comprimento deve ser menor ou igual a {length} dígitos'
  },
  ar: {
    SUMOR_REQUIRED: 'حقل إلزامي',
    SUMOR_STRING_LENGTH: 'يجب أن يكون الطول أقل من أو يساوي {length} حرفًا',
